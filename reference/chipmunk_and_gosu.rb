...
def image_url(file)
  "/Users/sparker/.rvm/gems/ruby-1.9.3-p0@gosu_scratch/gems/gosu-0.7.43-universal-darwin/examples/media/#{file}"
end
...
class Player
  ...
  def initialize(window, shape)
    @image = Gosu::Image.new(window, image_url("Starfighter.bmp"), false)
    @shape = shape
...
class GameWindow < Gosu::Window
  def initialize
    ...
    @background_image = Gosu::Image.new(self, image_url("Space.png"), true)

    # Put the beep here, as it is the environment now that determines collision
    @beep = Gosu::Sample.new(self, image_url("Beep.wav"))
    ...
    @star_anim = Gosu::Image::load_tiles(self, image_url("Star.png"), 25, 25, false)
    @stars = Array.new
